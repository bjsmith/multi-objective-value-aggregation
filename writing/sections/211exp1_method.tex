...
\begin{enumerate}
    ...
    \item Apply an objective specific scaling factor $c_i$ which is multiplied with the value of the utility. Different objectives likely have different scaling factors.  
...
These steps describe a value function which can be applied either to the individual utilities of each time-step or to the values of the Q-values. In our current setup we applied the functions to the Q values.
