...
public class PerturbBottleDrop
{
	...
	public static void runExperiments() {
		...
		Map<String, EnvGenerator> envs = new HashMap<String, EnvGenerator>(){{
			double[] bottleDropProbs = {0.01, 0.03, 0.1, 0.3, 1};
			//String[] base_envs = {"BreakableBottles","UnbreakableBottles"};
			for (double bdp : bottleDropProbs) {
				put("BreakableBottles,dropProb="+bdp, new EnvGenerator(){public EnvironmentInterface getEnv(String[] args) {return new BreakableBottlesSideEffectsV2(bdp);}});
				put("UnbreakableBottles,dropProb="+bdp, new EnvGenerator(){public EnvironmentInterface getEnv(String[] args) {return new UnbreakableBottlesSideEffectsV2(bdp);}});
		...
		String experiment_id = "PerturbBottleDrop";
		String outpath = "data/"+experiment_id;
		String format = "csv";
		int num_online = 5000;
		int num_offline = 10;
