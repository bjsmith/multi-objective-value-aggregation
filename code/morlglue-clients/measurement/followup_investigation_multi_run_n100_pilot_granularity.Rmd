...
significance_abridged <- table_env_long %>%
  filter(RewGranularity %in% c(10^-2,10^0,10^2) | PenGranularity %in% c(10^-2,10^0,10^2)) %>%
...
significance_abridged_output %>%  writeLines("../../../output/tables/significance_granularity.tex")
```
