...
```{r message=FALSE}
source_path <- "../data/comparison_3_runs/"
...
#within each of these three categories, give every distinct FILEID a unique RunID
...
raw_activity[Environment=="UnbreakableBottles" & EpisodeType=="Online",]%>% 
  dcast.data.table(RunId~Agent,value.var="R^*",fun.aggregate = mean)
```
