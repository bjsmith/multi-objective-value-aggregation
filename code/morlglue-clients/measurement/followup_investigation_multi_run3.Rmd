...
raw_activity <- get_presummarized_csv_activity_dt(file_list,source_path)
...
episode_summary[is.na(episode_summary$EnvironmentValueChange),]$EnvironmentValueChange <- 1
