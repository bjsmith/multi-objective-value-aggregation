...
setnames(table_env_long,"EnvironmentDimChange","Objective Scale",skip_absent=TRUE)
...
for (env_dim in c("pen","rew")){
  relevant_activity <- activity_means %>% dplyr::filter(EnvironmentDimChange %in% c("",env_dim))
    ...
    ggsave(filename=paste0(output_dir, "online",env_dim,".png"),plot=presentation_plot,device="png",width = 6,height=7)
