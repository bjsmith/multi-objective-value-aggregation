...
public class MORL_Glue_Local_vary_UA extends MORL_Glue_Local_Base
{
...
//			put("UnbreakableBottles", new EnvGenerator(){public EnvironmentInterface getEnv(String[] args) {return new UnbreakableBottlesSideEffectsV2();}});
			put("SokobanBoxPositionPenalty_0_01", new EnvGenerator(){public EnvironmentInterface getEnv(String[] args) {
				return new SokobanSideEffects(1,1,0.01);
				
				}});
			
			put("SokobanBoxPositionPenalty_0_05", new EnvGenerator(){public EnvironmentInterface getEnv(String[] args) {
				return new SokobanSideEffects(1,1,0.05);
				
				}});
			
			put("SokobanBoxPositionPenalty_0_2", new EnvGenerator(){public EnvironmentInterface getEnv(String[] args) {
				return new SokobanSideEffects(1,1,0.2);
			...
			put("SokobanBoxPositionPenalty5", new EnvGenerator(){public EnvironmentInterface getEnv(String[] args) {
				return new SokobanSideEffects(1,1,5);
				}});
			
			put("SokobanBoxPositionPenalty20", new EnvGenerator(){public EnvironmentInterface getEnv(String[] args) {
				return new SokobanSideEffects(1,1,20);
				}});
			
			put("SokobanBoxPositionPenalty100", new EnvGenerator(){public EnvironmentInterface getEnv(String[] args) {
				return new SokobanSideEffects(1,1,100);
				}});
