 ...
 * @author Brian Tanner
 */
public class SkeletonEnvironment2 implements EnvironmentInterface {
    ...
    public Reward_observation_terminal env_step(Action thisAction) {
        ...
        Observation returnObservation=new Observation(1,0,0);
        returnObservation.intArray[0]=currentState;
        Reward theRewardObject = new Reward(0,1,0);
        theRewardObject.setDouble(0, theReward);
        Reward_observation_terminal returnRewardObs=new Reward_observation_terminal(theRewardObject,returnObservation,episodeOver);
   ...
   /**
    ...
    public static void main(String[] args){
        EnvironmentLoader theLoader=new EnvironmentLoader(new SkeletonEnvironment2());
        theLoader.run();
    }
