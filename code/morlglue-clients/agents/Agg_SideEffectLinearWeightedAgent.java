...
public class Agg_SideEffectLinearWeightedAgent implements AgentInterface {
    ...
    public Agg_SideEffectLinearWeightedAgent(String[] args) {
    ...
    {
    	System.out.println("Agent step "+reward+", "+observation);
        numOfSteps++;
    ...
    public static void main(String[] args) {
        ...
        AgentLoader theLoader = new AgentLoader(host, port, new Agg_SideEffectLinearWeightedAgent(args) );
        theLoader.run();
