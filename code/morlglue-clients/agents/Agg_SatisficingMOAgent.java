...
public class Agg_SatisficingMOAgent implements AgentInterface {
    ...
    public Agg_SatisficingMOAgent(String[] args) {
    ...
    public static void main(String[] args) {
        AgentLoader theLoader = new AgentLoader( new Agg_SatisficingMOAgent(args) );
        theLoader.run();
